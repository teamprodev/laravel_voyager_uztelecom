   ...
   <div class="mr-auto grid grid-cols-3 w-12/12">
       @foreach($faqs as $faq)
            <div class="p-6 m-4 max-w-sm bg-white rounded-lg border w-full border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                ...
                <a href="{{route('site.faqs.show', $faq)}}" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Читать дальше
