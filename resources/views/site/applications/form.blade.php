            ...
            <div class="p-6">
                    <table class="table-auto">
                        ...
                        <tr>
                            ...
                            <td class="w-50 border p-2">
                                <input type="text" id="name" name="name" class="focus:outline-none w-full border w-full">
                        ...
                        <tr>
                            ...
                            <td class="w-50 border p-2">
                                <input type="text" class="focus:outline-none border w-full">
                        ...
                        <tr>
                            ...
                            <td class="w-50 border p-2">
                                <input type="text" class="focus:outline-none border w-full" value="">
                        ...
                        <tr>
                            ...
                            <td class="w-50 border p-2">
                                <input id="amount" name="amount" type="text" class="focus:outline-none border w-full">
