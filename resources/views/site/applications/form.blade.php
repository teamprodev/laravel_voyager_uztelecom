...
>>>>>>> 86e73cf1a9faa4d28bc403348509fded124354da
        </div>
            ...
            <div class="w-full mt-4 px-2">
                <div class="w-full">
                    <div class="">
                        ...
                        @endphp
                        {{Aire::select($roles, 'select2', 'Выбор из нескольких
                        вариантов из список утверждающих')
                            ->name('sign_roles')
                            ->required()
                            ->multiple()
                            ->value([2, 3])
    ...
    <div class="w-full text-right py-4 pr-10">
        <button class="bg-blue-500 hover:bg-blue-700 p-2 transition duration-300 rounded-md text-white">Сохранить и
            закрыть
        </button>
