...
<link href="https://cdn.datatables.net/1.10.21/css/jquery.dataTables.min.css" rel="stylesheet">
    ...
    <div class="w-11/12 mx-auto mt-6">
        ...
        <table   class="border-collapse border border-slate-400 yajra-datatable">
            <thead>
            <tr class="border ">
                ...
                <th class="px-5 py-3 border-b-2 border-gray-200 bg-gray-100  text-sm font-semibold text-gray-600 uppercase tracking-wider">Action</th>
            </tr>
            </thead>
            <tbody>
