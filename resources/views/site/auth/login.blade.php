            ...
            <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                ...
                <form>
                    ...
                    <div class="text-center mt-6">
                        <button class="modal-open bg-blueGray-800 text-white active:bg-blueGray-600 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150" type="button"> Sign In </button>
                    </div>
                </form>
            </div>
        </div>
