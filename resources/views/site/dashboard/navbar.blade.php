<nav class="bg-white fixed w-10/12 z-50 right-0 border-gray-200 sm:px-4 py-2.5 dark:bg-gray-800 border-b shadow-md topnavbar">
    <div class="flex justify-between flex-wrap items-center mx-auto">
        ...
        <div class="hidden relative w-5/12 mr-3 md:block">
            ...
            <input type="search" id="email-adress-icon" class="focus:outline-none block p-2 pl-10 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search...">
        </div>
