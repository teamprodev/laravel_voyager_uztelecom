        ...
        <div>
                <li class="flex-1 md:flex-none md:mr-3">
                    <div class="relative inline-block">
                        ...
                        <div id="NotificationDropdown" class="dropdownlist absolute bg-blue-500 text-black right-0 mt-3 p-3 overflow-auto z-30 invisible">
                            <input type="text" class="drop-search focus:outline-none rounded p-2 text-gray-600" placeholder="Search.." id="myInput" onkeyup="filterDD('NotificationDropdown','myInput')">
