<ul>
    <div class=" my-4 py-2 text-xs{{Request::is("ru/site/applications") ? " border-2 border-white":''}} hover:border-2 hover:border-white rounded-md">
    ...
    <div class=" my-4 py-2 text-xs{{Request::is("ru/site/applications/create") ? " border-2 border-white":''}} hover:border-2 hover:border-white rounded-md">
    ...
    <div class=" my-4 py-2 text-xs{{Request::is("ru/site/faqs") ? " border-2 border-white":''}} hover:border-2 hover:border-white rounded-md">
