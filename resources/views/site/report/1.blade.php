...
<table id="example" class="display wrap table-bordered dt-responsive" style="border-collapse: collapse; width: 100%; padding-top: 10px">
    ...
    <tr class="border border-dark">
        ...
        <th style="text-align: center;" class="border border-dark">Количество заявок</th>
        ...
        <th style="text-align: center;" class="border border-dark">Сумма без НДС</th>
        <th style="text-align: center;" class="border border-dark">Сумма с НДС</th>
    </tr>
    </thead>
</table>
