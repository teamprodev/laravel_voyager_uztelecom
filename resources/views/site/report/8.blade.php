...
<x-laravelYajraLoc dom='Blfrtip' getData="{{ route('report','8') }}" tableTitle="{{__('8 - Отчет по видам закупки')}}" startDate="{{request()->input('startDate')}}" endDate="{{request()->input('endDate')}}"/>
@endsection
