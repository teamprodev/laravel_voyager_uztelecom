...
<div style="text-align: end;margin-right: 100px">
  ...
  ->helpText('Browser-native month picker (minimal browser support)')->value(Illuminate\Support\Facades\Cache::get('date_5'))->name('date_5')}}
...
@if(Illuminate\Support\Facades\Cache::get('date_5') != null)
    <table id="example" class="display nowrap">
        ...
        <tr style="text-align: center;">
            <td colspan="10" style="background-color: #2cb74c"><b style="margin-left: 150px">{{Illuminate\Support\Facades\Cache::get('date_5')}} oy</b>
        </tr>
        <tr style="text-align: center;">
            <td colspan="4"><b style="margin-left: 940px;">Заключенные договора</b></td>
