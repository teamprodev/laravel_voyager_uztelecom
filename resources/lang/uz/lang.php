...
return [
    ...
    "table_10" => "Xarid qilinadigan mahsulotning tavsifi (texnik xarakteri)",
    "table_11" => "Asos (xaridlar rejasi, rahbariyat tomonidan bildirgi)",
    "table_12" => "Alohida talablar",
    "other" => "Mahsulotga qo'yilgan boshqa talablar(ish, xizmat)",
    ...
    "table_5" => "Mahsulotni keltirish uchun qo'yilgan talab INCOTERMS (ombordan olib ketish/ xaridorga yetkazib berish)",
    "table_50" => "Mahsulotni keltirish uchun qo'yilgan talab INCOTERMS",
