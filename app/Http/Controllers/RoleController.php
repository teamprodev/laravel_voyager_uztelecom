...
class RoleController extends VoyagerRoleController
{
    ...
    const Permission_All_Branch = 198;
    const Permission_Add_Company_Signer = 166;
    ...
    **/
    ...
    public function store(Request $request)
    {
        ...
        foreach ($request->branch_id as $branch)
        {
            ...
            if(in_array(self::Permission_Company_Signer,$request->permissions)||in_array(self::Permission_Branch_Signer,$request->permissions))
            {
                ...
                $model->save();
            }elseif(in_array(self::Permission_Add_Company_Signer,$request->permissions)||in_array(self::Permission_Add_Branch_Signer,$request->permissions)){
    ...
    {
        in_array(self::Permission_All_Branch,$request->permissions) ? $request->branch_id = Branch::pluck('id')->toArray(): [];
    ...
    /**
     * @param int $number
     * Number 1 kelsa @param $role_1
     * signers columnga tushadi va agar u add_signers da bo'lsa o'chirib tashlanadi.
     *
     * Number 0 kelsa @param $role_1
     * add_signers columnga tushadi va agar u signers da bo'lsa o'chirib tashlanadi.
     **/
