...
<?php $__env->startSection('center_content'); ?>
    <div class="pl-4 pt-4">
        <a href="<?php echo e(route('site.applications.edit',$application->id)); ?>" class="btn btn-outline-success">Изменить</a>
    </div>
        ...
        <h5><strong>ID : </strong> <?php echo e($application->id); ?>
            ...
            <h5><strong>Date : </strong>
                <?php if($application->date!=null): ?>
                    <?php echo e(Carbon\Carbon::createFromFormat('Y-m-d', $application->date)->Format('d.m.Yг')); ?>
    ...
    ->post()); ?>
            ...
            <?php if($user->hasPermission('Plan_Budget') && $application->user_id != auth()->user()->id || $user->hasPermission('Plan_Business') && $application->user_id != auth()->user()->id): ?>
                ...
                <?php if($user->hasPermission('Number_Change')): ?>
                    <?php echo $__env->make('site.components.number_change', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>
                <?php echo e(Aire::submit('Save')); ?>


            <?php elseif($user->hasPermission('Number_Change') && !$user->hasPermission('Plan_Budget') && !$user->hasPermission('Plan_Business') && $application->user_id != auth()->user()->id): ?>
                <?php echo $__env->make('site.components.number_change', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php echo e(Aire::submit('Save')); ?>
            ...
            <?php if($application->user_id != auth()->user()->id && auth()->user()->hasPermission('Company_Leader') && $application->status == 'agreed'): ?>
                <?php if(!isset($application->performer_user_id)): ?>
                    <?php echo $__env->make('site.components.leader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>
    ...
    <?php if($access && $user->hasPermission('Company_Signer'||'Add_Company_Signer'||'Branch_Signer'||'Add_Branch_Signer'||'Company_Performer'||'Branch_Performer') || $user->role_id == 7 && $application->show_director == 1): ?>
        <div class="px-6">
            <form name="testform" action="<?php echo e(route('site.applications.imzo.sign',$application->id)); ?>"        method="POST">
                <?php echo csrf_field(); ?>
    ...
    <script src="<?php echo e(asset("assets/js/eimzo/e-imzo.js")); ?>"></script>
    <script src="<?php echo e(asset("assets/js/eimzo/e-imzo-client.js")); ?>"></script>
    <script src="<?php echo e(asset("assets/js/eimzo/eimzo.js")); ?>"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('site.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\OpenServer\domains\laravel_voyager_uztelecom\resources\views/site/applications/show.blade.php ENDPATH**/ ?>