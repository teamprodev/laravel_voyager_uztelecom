...
<table id="example" class="display wrap table-bordered dt-responsive" style="border-collapse: collapse; width: 100%; padding-top: 10px">
    <thead class="border border-dark">
        <tr class="border border-dark">
            ...
            <th style="text-align: center;" class="border border-dark"><?php echo e(__('Количество заявок')); ?></th>
            ...
            <th style="text-align: center;" class="border border-dark"><?php echo e(__('Сумма без НДС')); ?></th>
            <th style="text-align: center;" class="border border-dark"><?php echo e(__('Сумма с НДС')); ?></th>
        </tr>
    </thead>
</table>
...
<script>
    ...
    var getData = "<?php echo e(route('report','1')); ?>";
    var tableTitle = "<?php echo e(__('1 - Отчет общий')); ?>";

</script>
<?php echo $__env->make('site.components.yajra', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('site.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\OpenServer\domains\laravel_voyager_uztelecom\resources\views/site/report/1.blade.php ENDPATH**/ ?>