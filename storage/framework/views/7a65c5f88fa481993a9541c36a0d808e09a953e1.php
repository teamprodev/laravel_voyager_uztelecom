...
<div id="second" class="p-4 <?php echo e(\Route::currentRouteName()=="login" ? '' : "hidden"); ?>">
  ...
  <?php endif; ?>
    <?php echo $__env->make('site.auth.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script src="<?php echo e(asset('assets/js/eimzo/imzo.js')); ?>"></script>
</body>
</html>
<?php /**PATH C:\OpenServer\domains\ArabicDev\Uztelecom\laravel_voyager_uztelecom\resources\views/site/auth/auth.blade.php ENDPATH**/ ?>