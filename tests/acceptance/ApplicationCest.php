...
class ApplicationCest
{
    ...
    public function create(AcceptanceTester $I)
    {
        ...
        $I->fillField("input[name='name']", 'TEST!!!  Харид қилинган маҳсулотларни Республика ҳудудий омборхоналарига ва обьектларга етказиб бериш учун шартнома тузиш.');
    ...
    public function edit(AcceptanceTester $I)
    {
        ...
        $name = $I->grabTextFrom("//input[@name='initiator']");
        $I->fillField("input[name='initiator']", 'TEST!!! Бухара омборидан Республика омборхоналаригача (ёки обьектларгачам)');
